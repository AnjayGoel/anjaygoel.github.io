...
​		For those living under a rock, Facebook acquired WhatsApp back in 2014. It also owns Instagram, making it the largest player among social media platforms by a large margin. With the new policy, it will be able to harvest and integrate user data from all the three major platforms. To put things into perspective, it will give Facebook access to data of *2 Billion WhatsApp active users*, while Facebook itself has reported a MAU (Monthly Active Users)  of around 2.7 Billion in Q2 2020.
...
[Signal](https://signal.org/en/) seems to be pretty popular. Its [open-source](https://github.com/signalapp), developed by a company founded by Brian Action (One of the two founders of WhatsApp) and is endorsed by the likes of Elon Musk, Edward Snowden, etc.